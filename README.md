...
<a href="https://t.me/jaloliddin_fikrolog"><img alt="Telegram" src="https://img.shields.io/badge/telegram-gray?style=flat-square&logo=telegram"></a>
...
- 💻 &nbsp;  `.cpp` | `.cs` | `.py` | `.swift` | `.html` | `.css` 
- 🌐 &nbsp; .NET 6 | .Net8
- 🕸 &nbsp; jQuery | Bootstrap | HTML5 | CSS | Swift
<!--- 🛢 &nbsp; SqlServer | PostgreSql --->
- ⚙️ &nbsp; Git
- 🥷🏻 &nbsp; Codewars: ![image](https://www.codewars.com/users/jaloldcoder98/badges/micro)
